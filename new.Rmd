...
par(mfrow=c(2,2))
plot(lm.2)
title(sub="Figure 3. Checking conditions for full model",outer=TRUE)
```
...
par(mfrow=c(2,2))
plot(lm.3)
title(main="",sub="Figure 5. plot of Full Model and PI",outer=TRUE)
```
...
points(which.min(reg.summary2$bic ),reg.summary2$bic [which.min(reg.summary2$bic )],col="red",cex=2,pch=20)
title(sub="Figure 6. Model Selection using Best Subset")
```
